                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <div class="table-responsive mb-3">
                            <div class="col-sm-12">
                                        ...
                                        <label>
                                            <input type="text" id="accountSearch" class="form-control form-control-sm"
                                                   placeholder="账号" aria-controls="tableId">
                                        </label>
                            ...
                            <table id="tableId" class="table table-bordered table-striped">
                                ...
                                <tr>
                                    ...
                                    <th onclick="sort('mobile')">电话</th>
                                    <th onclick="sort('address')">住址</th>
...
<script>
    ...
    function search() {
        ...
        if ($('#accountSearch').val() != null && $('accountSearch').val() != '') {
            searchForm.account = $('#accountSearch').val();
    ...
    function remove(id) {
        ...
        if (mymessage == true) {
            ...
            httpJson("guanliyuan/delete", "POST", paramArray, (res) => {
                if(res.code == 0
        )
            {
                getDataList();
    ...
    function crossTable(id, crossTableName) {
        ...
        window.sessionStorage.setItem('crossTableName', "guanliyuan");
