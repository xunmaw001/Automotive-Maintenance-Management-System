            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">编辑员工表</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">员工表信息</h3>
                        <form id="addOrUpdateForm">
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                   ...
                                   <div class="form-group col-md-6">
                                       <label>技术职称</label>
                                       <select id="zcTypesSelect" name="zcTypes" class="form-control">
                                       </select>
                                   </div>
...
<script>
    ...
    function initializationZctypesSelect(){
        var zcTypesSelect = document.getElementById('zcTypesSelect');
            for (var i = 0; i < zcTypesOptions.length; i++) {
                zcTypesSelect.add(new Option(zcTypesOptions[i].indexName,zcTypesOptions[i].codeIndex));
            }
    }
    // 下拉框选项回显
    function setSelectOption() {
        ...
        for (var i = 0; i < zcTypesOptions.length; i++) {
            if(zcTypesOptions[i].codeIndex == ruleForm.zcTypes){//下拉框value对比,如果一致就赋值汉字
                document.getElementById("zcTypesSelect").options[i].selected = true;
            }
        }
    }
