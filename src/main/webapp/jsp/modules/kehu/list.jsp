    ...
    <div id="content">
        ...
        <div class="container mt-0">
            <div class="row breadcrumb-bar">
                <div class="col-md-6">
                    <h3 class="block-title">客户信息表管理</h3>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">客户信息表管理</li>
                        <li class="breadcrumb-item active">客户信息表列表</li>
                    </ol>
                </div>
            </div>
        </div>
                        ...
                        <div class="table-responsive mb-3">
                            ...
                            <table id="tableId" class="table table-bordered table-striped">
                                ...
                                <tr>
                                    ...
                                    <th onclick="sort('serial')">客户编号</th>
                                    <th onclick="sort('name')">客户姓名</th>
                                    <th onclick="sort('account')">账号</th>
                                    <th onclick="sort('password')">密码</th>
                                    <th onclick="sort('age')">客户年龄</th>
                                    <th onclick="sort('sexTypes')">客户性别</th>
                                    <th onclick="sort('mobile')">联系方式</th>
                                    <th onclick="sort('role')">身份</th>
                                    <th onclick="sort('information')">车辆信息</th>
                                    <th>操作</th>
                                </tr>
                                </thead>
                                <tbody>
